...
状態: **Superseded（→ SPEC-08c。LAUNCH DECK の発進口・ベスト・操作早見表は現行）** ／ 当時: **Implemented (2026-07-20 テスト17/17グリーン・A/B/ゲーム回帰込み。C-08のREADME/meta同期はPhase Dで実施)** ／ 親: [SPEC-07](07-scroll-guide.md) ／ 前提: 07b Verified ／ 外部素材: 不要
