...
状態: **Draft** ／ 親: [SPEC-13](13-cockpit-holo.md) ／ 計画: [13-implementation-plan.md](13-implementation-plan.md) ／ テスト: `tests/phaseK1.js`
...
const CK = {
  ...
  bow:    {r: 2.05, tube: .03, y: -1.0, z: -1.95, arc: 2.9},
  glass:  {r: 2.3, y: -.2, phi: [Math.PI*1.5 - 1.5, 3.0], theta: [.25, 1.6], grid: [18, 9]},
  stick:  {pos: [0, -.76, -.55], scale: 1.3, kx: .45, kz: .5, trigger: .08},
  meter:  {pos: [-.44, -.47, -1.0], rot: [-.3, .32, 0], scale: IS_TOUCH ? 1.3 : .95, canvas: [540, 300], plane: [.54, .3]},
  radar:  {pos: [.46, -.5, -.92], rot: [-1.0, 0, -.25], size: .36, canvas: 256},
...
| ラベル | `km/s`（**26px**・状態色）・`THR nn%`（**26px**・琥珀、`nn = round(speed/SPD_MAX*100)`） |
